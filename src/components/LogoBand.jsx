...
const LOGO_CONFIG = [
  ...
  { file: 'logo-meguiars',                compact: true,  scale: 1.04, yOffset: 0 },
  { file: 'logo-beach-hop',               compact: false, scale: 0.99, yOffset: 0 },
  ...
  { file: 'logo-spark-foundry',           compact: false, scale: 0.82, yOffset: 4 },
  { file: 'logo-bmw',                     compact: true,  scale: 1.08, yOffset: 0 },
  { file: 'logo-aecs',                    compact: false, scale: 0.82, yOffset: 4 },
  { file: 'logo-ryco',                    compact: false, scale: 0.82, yOffset: 4 },
  { file: 'logo-blackfern',               compact: true,  scale: 1.0, yOffset: 0 },
  { file: 'logo-atomic-212',              compact: false, scale: 0.97, yOffset: 0 },
  { file: 'logo-niterra',                 compact: false, scale: 0.99, yOffset: 0 },
  { file: 'logo-toyota',                  compact: true,  scale: 1.0, yOffset: 0 },
  { file: 'logo-mito',                    compact: true,  scale: 1.08, yOffset: 0 },
  { file: 'logo-rapid-media',             compact: true,  scale: 1.0, yOffset: 0 },
  { file: 'logo-mount-shop',              compact: true,  scale: 1.04, yOffset: 0 },
  ...
  { file: 'logo-premier-events',          compact: false, scale: 0.985, yOffset: 0 },
  { file: 'logo-repco',                   compact: false, scale: 1.0, yOffset: 0 },
  { file: 'logo-smits-group',             compact: true,  scale: 1.0, yOffset: 0 },
  { file: 'logo-mindshare',               compact: false, scale: 0.985, yOffset: 0 },
  { file: 'logo-harrys-euro',             compact: false, scale: 0.985, yOffset: 0 },
  { file: 'logo-ac-delco',                compact: false, scale: 1.0, yOffset: 4 },
  { file: 'logo-infinitev',               compact: true,  scale: 1.02, yOffset: 0 },
  { file: 'logo-subaru',                  compact: true,  scale: 1.0, yOffset: 0 },
  { file: 'logo-tyrewise',                compact: false, scale: 1.0, yOffset: 0 },
  { file: 'logo-1st-auto-parts',          compact: false, scale: 0.985, yOffset: 0 },
  ...
  { file: 'logo-valvoline',               compact: true,  scale: 1.0, yOffset: 1 },
  { file: 'logo-ace-auto-parts',          compact: false, scale: 0.975, yOffset: 0 },
  { file: 'logo-mobil',                   compact: false, scale: 1.0, yOffset: 0 },
  { file: 'logo-audi',                    compact: true,  scale: 1.0, yOffset: 0 },
  { file: 'logo-rare-spares',             compact: true,  scale: 1.0, yOffset: 1 },
  { file: 'logo-auto-master',             compact: false, scale: 0.985, yOffset: 1 },
  ...
  { file: 'logo-exedy',                   compact: false, scale: 0.88, yOffset: 0 },
